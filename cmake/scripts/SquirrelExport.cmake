...
macro(dump_class_templates NAME)
    ...
    if("${NAME}" STREQUAL "ScriptEvent")
        string(APPEND SQUIRREL_EXPORT "\n\ttemplate <> struct Return<${NAME} *> { static inline SQResult Set(HSQUIRRELVM vm, ${NAME} *res) { if (res == nullptr) { sq_pushnull(vm); return SQResult::RETURN; } Squirrel::CreateClassInstanceVM(vm, \"${REALNAME}\", res, nullptr, DefSQDestructorCallback<${NAME}>, true); return SQResult::RETURN; } };")
    elseif("${NAME}" STREQUAL "ScriptText")
        ...
        string(APPEND SQUIRREL_EXPORT "\n\ttemplate <> struct Return<${NAME} *> { static inline SQResult Set(HSQUIRRELVM vm, ${NAME} *res) { if (res == nullptr) { sq_pushnull(vm); return SQResult::RETURN; } res->AddRef(); Squirrel::CreateClassInstanceVM(vm, \"${REALNAME}\", res, nullptr, DefSQDestructorCallback<${NAME}>, true); return SQResult::RETURN; } };")
    endif()
endmacro()
...
foreach(LINE IN LISTS SOURCE_LINES)
    ...
    if("${LINE}" MATCHES "^([ \t]*)$")
        ...
        string(APPEND SQUIRREL_EXPORT "\n")
        string(APPEND SQUIRREL_EXPORT "\ntemplate <> SQResult PushClassName<${CLS}, ScriptType::${APIUC}>(HSQUIRRELVM vm) { sq_pushstring(vm, \"${API_CLS}\"); return SQResult::RETURN; }")
        string(APPEND SQUIRREL_EXPORT "\n")
